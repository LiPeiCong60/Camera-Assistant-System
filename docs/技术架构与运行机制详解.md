...
Camera Assistant 是一个“手机拍摄 + 本地设备联动 + AI 分析 + 管理后台”的多端系统。它既支持手机独立完成拍摄、模板叠加、照片上传和 AI 分析，也支持手机把摄像头画面推到树莓派或本机设备运行端，由设备端执行实时人体检测、构图判断、云台控制、抓拍、AI 背景锁和预览回传。
