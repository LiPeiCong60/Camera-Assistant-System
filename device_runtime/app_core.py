...
from device_runtime.interfaces.capture_trigger import CaptureTrigger
...
from device_runtime.utils.ui_text import FOLLOW_TEXT, SPEED_TEXT, follow_to_text, speed_to_text
